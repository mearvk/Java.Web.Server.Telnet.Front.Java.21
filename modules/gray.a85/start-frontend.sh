#!/bin/bash
# ═══════════════════════════════════════════════════════════════════════════════
# NitroWebExpress™ — Gray85 Port Registry Frontend Startup
...
echo ""
echo "╔═══════════════════════════════════════════════════════════════════════════╗"
echo "║  Gray85 Port Registry — Frontend Startup                                  ║"
...
if [ "$HTTP_CODE" = "200" ] || [ "$HTTP_CODE" = "302" ]; then
    echo "  [✓] Gray85 Port Registry webapp is UP — http://localhost:8080/$CONTEXT/"
else
